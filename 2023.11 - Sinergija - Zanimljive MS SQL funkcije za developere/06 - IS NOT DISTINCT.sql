...
WHERE PickingCompletedWhen <> '2013-01-01 12:00:00.0000000' AND OrderID >= 690
ORDER BY OrderID;

SELECT OrderID, PickingCompletedWhen FROM Sales.Orders
WHERE PickingCompletedWhen IS DISTINCT FROM '2013-01-01 12:00:00.0000000'  AND OrderID >= 690
ORDER BY OrderID;
