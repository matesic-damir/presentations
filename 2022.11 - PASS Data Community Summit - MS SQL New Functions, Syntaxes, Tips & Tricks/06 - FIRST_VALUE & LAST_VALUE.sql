...
-- Retrieve employees by department and pay grade, when they were hired, 
-- the first and last date of employment in that department
...
-- An employee with fewer vacations within one department
